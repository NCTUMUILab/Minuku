...
//            ContextExtractor.getLocationRequester().setLocationUpdateInterval(LocationRequester.LOCATION_UPDATE_SLOW_INTERVAL_IN_SECONDS);
            ...
            LogManager.log(LogManager.LOG_TYPE_SYSTEM_LOG,
                    ...
                    "Alarm Received:\t" + MobilityManager.ALARM_MOBILITY + "\t" + MobilityManager.STATIC + "\t" + "new location interval" + LocationRequester.LOCATION_UPDATE_SLOW_INTERVAL_IN_SECONDS);
            ...
            //slow down locationUpdate rate
  //          ContextExtractor.getLocationRequester().setLocationUpdateInterval(LocationRequester.LOCATION_UPDATE_FAST_INTERVAL_IN_SECONDS);

            ContextExtractor.getLocationRequester().requestUpdates();
            LogManager.log(LogManager.LOG_TYPE_SYSTEM_LOG,
                    LogManager.LOG_TAG_ALARM_RECEIVED,
                    "Alarm Received:\t" + MobilityManager.ALARM_MOBILITY + "\t" + MobilityManager.MOBILE + "\t" + "new location interval" + LocationRequester.LOCATION_UPDATE_FAST_INTERVAL_IN_SECONDS);
